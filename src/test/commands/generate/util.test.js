...
import { createRandomNumberByRange, createRandomStringByRange } from "../../../commands/generate/util";
...
describe("util", () => {
  test("createRandomStringByRange", async() => {
    ...
    expect(createRandomStringByRange(undefined, undefined).length).toBeGreaterThanOrEqual(0)
  ...
  test("createRandomNumberByRange", async() => {
    ...
    expect(createRandomNumberByRange(undefined, undefined)).toBeGreaterThanOrEqual(0)
